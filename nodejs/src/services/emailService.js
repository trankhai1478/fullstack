...
let sendSimpleEmail = async (dataSend) => {
  ...
  let info = await transporter.sendMail({
    from: '"Medical 👻" <trankhai1478@gmail.com>', // sender address
...
<p>Bạn nhận được email này vì đã đặt lịch khám bệnh online trên Medical</p>
...
`;
  ...
  if (dataSend.language === "en") {
    ...
    <p>You received this email because you booked an online medical appointment on Medical</p>
